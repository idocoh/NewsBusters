...
class GoogleVec(object):
    ...
    #def __init__(self, path='freebase-vectors-skipgram1000.bin'):
    def __init__(self, path='lexvec.enwiki+newscrawl.300d.W.pos.vectors'):
    ...
    def load(self):
        t0 = time.time()
        self.model = gensim.models.KeyedVectors.load_word2vec_format(self.path,unicode_errors='ignore', binary=True)#, limit=900000)
        print time.time() - t0
    ...
    def shared(self):
        return theano.shared(self.model.syn0, name='Google Vectors', borrow=True)
