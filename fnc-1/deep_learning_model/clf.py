...
if __name__ == '__main__':
    ...
    #v.vocab = dict(v.vocab.items()[len(v.vocab)/40:])
    #print len(v.vocab)
    emb_mat = v.shared()
    ...
    # test_news = News(stances='competition_test_stances_unlabeled.csv', vecs=v, bodies='competition_test_bodies.csv')

    test_news = News(stances='train_chen_unlabled.csv', vecs=v, bodies='train_bodies_chen.csv')
    ...
    if eval_test:
        ...
        #with open('params-new_w2v.p', 'r') as f:
        #with open('params_meital.p', 'r') as f:
    ...
    for i in xrange(35000000):
        ...
        if i%50==0:
            print "50 mod:", i, np.mean(costs), time.time() - t0
            t0 = time.time()
            costs = []
        ...
        if i%500==0 and i>10:
            ...
            if m>best_score:
                print 'SAVED ---------------------------',m
                best_score = m
                with open('params-new_w2v.p','wb') as f:
